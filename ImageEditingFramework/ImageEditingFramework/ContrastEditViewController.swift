//
//  ContrastEditViewController.swift
...
public class ContrastEditViewController: EditViewController {
   
    //MARK: Properties
    var slider : UISlider? = nil
    var lowerValue : Float = 0.8
    var upperValue : Float = 1.2
    ...
    func sliderValueChanged(sld : UISlider)
    {
        ...
        var filter : CIFilter = CIFilter(name: "CIColorControls", withInputParameters: [kCIInputImageKey : ci, "inputContrast": sld.value]);
